            ...
            <footer class="site-footer" role="contentinfo">
                            ...
                            <%-- Column 2: Navigation --%>
                                <div class="footer-col">
                                    ...
                                    <ul class="footer-col__list">
                                        <li><a href="${pageContext.request.contextPath}/product/list">Tất cả sản
                                                phẩm</a></li>
                                        <li><a href="${pageContext.request.contextPath}/product/list?categoryId=1">Giày
                                                đá bóng</a></li>
                                        <li><a href="${pageContext.request.contextPath}/product/list?categoryId=2">Áo
                                                thi đấu</a></li>
                                        <li><a href="${pageContext.request.contextPath}/product/list?categoryId=3">Quần
                                                thể thao</a></li>
                                        <li><a href="${pageContext.request.contextPath}/product/list?categoryId=4">Bóng
                                                đá</a></li>
                                        <li><a href="${pageContext.request.contextPath}/product/list?brandId=sale">Khuyến
                                                mãi</a></li>
                                    </ul>
                                </div>
                                ...
                                <%-- Column 3: Account --%>
                                    <div class="footer-col">
                                        ...
                                        <ul class="footer-col__list">
                                            <c:choose>
                                                <c:when
                                                    test="${not empty sessionScope.authUser or not empty sessionScope.user}">
                                                    <li><a href="${pageContext.request.contextPath}/account">Hồ sơ cá
                                                            nhân</a></li>
                                                    <li><a href="${pageContext.request.contextPath}/order/history">Lịch
                                                            sử đơn hàng</a></li>
                                                    <li><a href="${pageContext.request.contextPath}/address">Địa chỉ
                                                            giao hàng</a></li>
                ...
                <%-- Bottom bar --%>
                    <div class="container footer-bottom">
                        <span>©
                            <fmt:formatDate value="<%= new java.util.Date() %>" pattern="yyyy" /> SportShop. Mọi quyền
                            được bảo lưu.
                        </span>
                    ...
                    <%-- Back to top button --%>
                        <button id="back-to-top" title="Về đầu trang" aria-label="Về đầu trang" style="display:none;position:fixed;bottom:2rem;right:2rem;width:44px;height:44px;
